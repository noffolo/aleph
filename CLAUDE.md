...
This project is indexed by GitNexus as **aleph** (22953 symbols, 56646 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
