...
<span className="text-[10px] tracking-widest uppercase leading-snug mb-2">{t('errors.panel')}</span>
           <p className="text-textMuted text-xs mb-4">{t('errors.componentError')}</p>
<button
