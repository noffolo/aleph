...
export const SkillsView: React.FC<SkillsViewProps> = React.memo(({ skills: initialSkills, tools, onCreateSkill, onViewSkillDetail, onDeleteSkill, onRunSkill, inline = false, isLoading, error }) => {
