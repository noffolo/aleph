...
**Percorso piano**: `docs/superpowers/plans/29-apr-plan.md`
**Specifiche collegate**: `docs/superpowers/specs/29-apr-plan.md`
...
- `docs/superpowers/specs/29-apr-plan.md` — Specifiche tecniche delle wave (protobuf, DB schema, API contract, prompt design, security migration)
